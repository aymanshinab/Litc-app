...
if (document.getElementById("pie-chart") && typeof ApexCharts !== 'undefined') {
  ...
  chart.render();
    ...
    <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 m-4 md:p-6">
    ...
    <div class="   flex   justify-around  items-center  pb-20  mt-7   ">
        <div class="  bg-[#F3F4F6] flex w-[235px]  rounded-md  justify-start shadow-xl   items-center pb-6 pt-4 ">
            <div> <i
                    class="fa-solid fa-warehouse ml-7 text-base w-[40px] h-[40px]  rounded-full  text-white bg-[#7B74EC] flex items-center justify-center mr-[15px]"></i>
            </div>
            <div>
                <h2 class=" font-bold  font-sans  text-xl  ">78 </h2>
                <span class=" text-sm  text-[#868999]"> Total Employee </span>
            </div>

        </div>
        <div
            class="bg-[#F3F4F6] flex w-[235px]  rounded-md  justify-start shadow-xl  items-center pb-6 pt-4 ">
            <div> <i
                    class="  fa-solid fa-building-user ml-7 text-base w-[40px] h-[40px]  rounded-full  text-white bg-[#5C8AF0] flex items-center justify-center mr-[15px]"></i>
            </div>
            <div>
                <h2 class=" font-bold  font-sans  text-xl  "> 76 </h2>
                <span class=" text-sm  text-[#868999]"> Total Employee</span>
            </div>
        ...
        <div
            class="bg-[#F3F4F6] flex w-[235px]  rounded-md  justify-start  shadow-xl  items-center pb-6 pt-4 ">
            <div
                class="  ml-7 text-base w-[40px] h-[40px]  rounded-full  text-white bg-[#cf3c3cfd] flex items-center justify-center mr-[15px]">


            </div>
            <div>
                <h2 class=" font-bold  font-sans  text-xl  "> 32/68
                </h2>
                <span class=" text-sm  text-[#868999]"> Total Employee
                </span>
        ...
        <div
            ...
            <div>
                <h2 class=" font-bold  font-sans  text-xl  "> 56</h2>
                <span class="  text-sm  text-[#868999]"> Total Employee </span>
            </div>
