...
<nav class="  border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700" style="position: fixed">
    <div class=" max-w-screen-xl flex flex-wrap items-center w-96 justify-between  p-2">
      <a href="#" class="">
          <span class="self-center text-lg font-semibold rounded-b-lg  dark:text-white">لوحة التحكم</span>
      </a>
